...
// gate over changes some other session already made — and so is
// `/pr-description`, which writes up a branch that some other session built.
// All three describe work rather than doing it.
//
...
const DEFAULT_COMMANDS = ['git-commit-message', 'git-review', 'pr-description'];
